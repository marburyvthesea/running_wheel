function [outputStatus, vidfileName] = singleCamWarmUp(inputCam, camNum, sweepTimeSeconds, pdir, sweepNum, freq)
...
vidfileName = [save_dir, '\', filetime, '_', num2str(sweepNum), '_', imaqhwinfo(inputCam).AdaptorName, ...
    '_', imaqhwinfo(inputCam).DeviceName, 'warmup_' , num2str(camNum)];
