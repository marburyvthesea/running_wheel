function [outputStatus, vidfileName] = singleCamAcquisitionDiskLoggingTimedDataStream(streamObject, inputCam, camNum, sweepTimeSeconds, pdir, sweepNum, freq)
